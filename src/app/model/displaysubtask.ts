...
export class DisplaySubTask extends SubTask {
  ...
  fits(field: Field): boolean {
    ...
    if (this.format.bold != null && this.format.bold !== field.display.bold) {
      return false;
    }
    if (this.format.italic != null && this.format.italic !== field.display.italic) {
      return false;
    }
    if (this.format.underline != null && this.format.underline !== field.display.underline) {
      return false;
    }
    if (this.format.strikethrough != null && this.format.strikethrough !== field.display.strikethrough) {
      return false;
    }
    return true;
  }
